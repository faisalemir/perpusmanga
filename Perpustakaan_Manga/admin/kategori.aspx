<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master Page/Manga.Master" CodeBehind="kategori.aspx.vb" Inherits="Perpustakaan_Manga.Kategori" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cph_cari" runat="server">
    <div class="div_cari">
        <asp:TextBox ID="tbx_cari" runat="server" Width="291px" ToolTip="Cari Admin . ." CssClass="tbx_cari"></asp:TextBox>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cph_tombol" runat="server">
    <a class="btn_tambah" href="tambahkategori.aspx">Tambah Kategori</a>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_isi" runat="server">
    <asp:GridView ID="gdv_tampil" runat="server"
        ...
        <Columns>
            <asp:BoundField DataField="kd_kategori" HeaderText="Kode" Visible="false"/>
            <asp:BoundField DataField="nama" HeaderText="Nama Kategori" HeaderStyle-Width="800px"/>
            <asp:HyperLinkField DataNavigateUrlFields="kd_kategori" DataNavigateUrlFormatString="~/admin/detailkategori.aspx?kode={0}" NavigateUrl="~/admin/detailkategori.aspx" Text="Detail" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="20px"/>
        </Columns>
    </asp:GridView>
</asp:Content>
