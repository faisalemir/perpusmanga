<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master Page/Manga.Master" CodeBehind="detailadmin.aspx.vb" Inherits="Perpustakaan_Manga.Detailadmin" %>
        ...
        <asp:Table runat="server" style="text-align:right;" ID="tbl_tambah" CellPadding="5" HorizontalAlign="Center">
            <asp:TableRow>
                ...
                <asp:TableCell style="text-align:left;">
                    <asp:Label ID="lbl_kd_admin" runat="server"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell style="width:50px; text-align:center;">:</asp:TableCell>
                <asp:TableCell style="text-align:left;">
                    <asp:Label ID="lbl_alamat" runat="server"></asp:Label>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell style="width:50px; text-align:center;">:</asp:TableCell>
                <asp:TableCell style="text-align:left;">
                    <asp:Label ID="lbl_jk" runat="server"></asp:Label>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell style="width:50px; text-align:center;">:</asp:TableCell>
                <asp:TableCell style="text-align:left;">
                    <asp:Label ID="lbl_ktp" runat="server"></asp:Label>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell style="width:50px; text-align:center;">:</asp:TableCell>
                <asp:TableCell style="text-align:left;">
                    <asp:Label ID="lbl_telp" runat="server"></asp:Label>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell style="width:50px; text-align:center;">:</asp:TableCell>
                <asp:TableCell style="text-align:left;">
                    <asp:Label ID="lbl_akses" runat="server"></asp:Label>
                    <asp:DropDownList ID="ddl_akses" runat="server" TabIndex="6" Width="217px" Enabled="false" >
            ...
            <asp:TableRow>
                ...
                <asp:TableCell style="text-align:left;">
                    ...
                    <asp:TextBox ID="tbx_id" runat="server" TabIndex="7" Width="200px" ReadOnly="true"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                ...
                <asp:TableCell style="text-align:left;">
                    ...
                    <asp:TextBox ID="tbx_pass" runat="server" TabIndex="8" Width="200px" ReadOnly="true"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow >
