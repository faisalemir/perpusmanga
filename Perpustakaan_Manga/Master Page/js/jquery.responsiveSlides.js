...
(function($){
	$.fn.responsiveSlides = function(options){
		...
		var overstyle='position:absolute; height:100%; width:100%; text-align:center; line-height:'+settings.height+'px; z-index:1; background-color:'+settings.background+';';
		...
		$('img',$('.tgtimg',_this)).onImagesLoad(function(){
			...
			if(p.active){
				...
				$(_this).append('<div class="pagination" style="position:absolute; z-index:2; '+pos+'">'+elm+'</div>');
